# Django settings for lernadostore project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'lernadostore',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'j*+5=(7=n!3fsmu@r)y@lu$_)2j8)aqn9@pysodo4#d9+%^&&4'
...
ROOT_URLCONF = 'lernadostore.urls'
